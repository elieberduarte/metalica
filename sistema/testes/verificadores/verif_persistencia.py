...
if len(sys.argv) < 2:
    print("precisa do servidor rodando com a pasta de projetos padrão (usa e regrava projetos/modelos/compressores-ar.modelo.json): python verif_persistencia.py PORTA")
    sys.exit(0)
