...
try:
    ...
    ok(aba.avaliar("document.querySelectorAll('#arquivos-corpo a').length") >= 6, "aba Arquivos com os links (CSV, HTML, PDF)")
    ok(aba.avaliar("document.querySelectorAll('#abas button[data-aba]').length") == 9, "nove abas")
