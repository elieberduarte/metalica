...
GRUPOS_ENTRADA = [
    ...
    ("Sistema estrutural", ["tipo_portico", "base_rotulada", "formato_tesoura",
                            "diagonais_tesoura", "ligacao_tesoura", "altura_tesoura",
                            "paineis_tesoura", "com_misula", "comprimento_misula",
                            "altura_misula"]),
    ("Materiais", ["aco_perfis", "aco_tercas", "aco_chapas", "parafuso", "eletrodo",
                   "fck_MPa"]),
    ("Perfis por elemento (vazio = escolhido pelo programa)",
     ["perfil_terca", "perfil_longarina", "perfil_viga", "perfil_pilar", "perfil_banzo_superior",
      "perfil_banzo_inferior", "perfil_diagonal", "perfil_montante", "banzos_duplos",
      "diagonais_duplas"]),
